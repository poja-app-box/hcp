package io.poja.health.handler;

import static io.poja.health.concurrency.ThreadRenamer.renameWorkerThread;
...
import io.poja.health.PojaApplication;
import io.poja.health.PojaGenerated;
import io.poja.health.endpoint.EndpointConf;
import io.poja.health.endpoint.event.EventConf;
import io.poja.health.endpoint.event.consumer.EventConsumer;
import io.poja.health.endpoint.event.consumer.model.ConsumableEvent;
import io.poja.health.endpoint.event.consumer.model.ConsumableEventTyper;
