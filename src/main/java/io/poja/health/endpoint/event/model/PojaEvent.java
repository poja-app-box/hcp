...
import static io.poja.health.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import io.poja.health.PojaGenerated;
import io.poja.health.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "io.poja.health.event1";
    return "io.poja.health.event2";
  }
}
