package io.poja.health.endpoint.event.consumer;

import io.poja.health.PojaGenerated;
import io.poja.health.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("io.poja.health.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "io.poja.health.service.event."
